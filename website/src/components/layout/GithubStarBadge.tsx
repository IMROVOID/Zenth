...
export function GithubStarBadge({
  ...
  return (
    <a
      ...
      className={`h-[38px] px-3.5 flex items-center gap-2 rounded-full border border-white/20 bg-transparent text-sm font-medium text-white hover:border-white/40 transition-colors ${className}`.trim()}
    >
      <svg
