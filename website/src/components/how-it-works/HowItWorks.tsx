  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at center, rgba(46, 224, 125, 0.12) 0%, rgba(24, 150, 92, 0.05) 45%, transparent 75%)',
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 w-full max-w-[96%] xl:max-w-[95%] 2xl:max-w-[1760px] mx-auto flex flex-col items-center">
        {/* Section Heading with Pill, Title, and Description */}
        <HowItWorksHeading />

        {/* 3-Box Interactive Widget */}
        <WidgetContainer />
      </div>
    </section>
  );
